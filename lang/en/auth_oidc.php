...
$string['cfg_oauthorigin_key'] = 'Authority origin';
$string['cfg_oauthorigin_desc'] = 'The URI of Authority origin';
$string['cfg_sessioncheckendpoint_key'] = 'Session check endpoint';
$string['cfg_sessioncheckendpoint_desc'] = 'The URI of session check page that be used for check session of a user login';
